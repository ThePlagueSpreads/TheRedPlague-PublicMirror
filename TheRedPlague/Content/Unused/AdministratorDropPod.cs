...
using TheRedPlague.Content.Fragments;
using UnityEngine;
using UWE;
...
public static class AdministratorDropPod
{
    ...
    private static void Register()
    {
        ...
        PingType = EnumHandler.AddEntry<PingType>("AdministratorDropPodPing")
            .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("AdministratorEscapePodPing"));
    }
    ...
    private static IEnumerator GetPrefab(IOut<GameObject> prefab)
    {
        ...
        exteriorMaterial.mainTexture = AssetBundles.Core.LoadAsset<Texture2D>("AdministratorEscapePodDecal");
