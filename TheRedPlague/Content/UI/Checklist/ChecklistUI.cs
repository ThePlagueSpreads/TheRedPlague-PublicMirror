...
public class ChecklistUI : MonoBehaviour, IStoryGoalListener
{
    ...
    public static void CreateChecklistUI(uGUI_LogTab logTab)
    {
        try
        {
            ...
            checklistUi.checkedSprite = AssetBundles.Core.LoadAsset<Sprite>("ChecklistChecked");
            checklistUi.uncheckedSprite = AssetBundles.Core.LoadAsset<Sprite>("ChecklistUnchecked");
    ...
    private IEnumerator Start()
    {
        ...
        Act2Story.ProcessAct2FollowUpMessages();
        RefreshMenu();
    }
