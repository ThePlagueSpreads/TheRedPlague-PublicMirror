...
public class MimicPeeper : CreatureAsset
{
    ...
    {
        var template = new CreatureTemplate(() => AssetBundles.Creatures.LoadAsset<GameObject>("MimicPeeper_Prefab"),
    ...
    protected override IEnumerator ModifyPrefab(GameObject prefab, CreatureComponents components)
    {
        ...
        var meleeAttack = CreaturePrefabUtils.AddMeleeAttack<MeleeAttack>(prefab, components,
            prefab.transform.Find("BiteTrigger").gameObject, true, 6, 10f, false);
    ...
    {
        MaterialUtils.ApplySNShaders(prefab, 8f, 1.5f, 0.4f, new GlowStrengthNightModifier(1f, 0.4f));
    }
}