...
namespace TheRedPlague.Content.Creatures.EyeyeCaptain;
...
public class EyeyeCaptain : CreatureAsset
{
    ...
    {
        var template = new CreatureTemplate(() => AssetBundles.Creatures.LoadAsset<GameObject>("EyeyeCaptainPrefab"),
    ...
    protected override IEnumerator ModifyPrefab(GameObject prefab, CreatureComponents components)
    {
        ...
        attack.eyePhysicsMaterial = AssetBundles.Creatures.LoadAsset<PhysicMaterial>("BouncyEyeMaterial");
