...
public static class FleshBlobLeaders
{
    ...
    {
        return;
        // TODO: Re-implement flesh blob leaders in a less invasive way
...
#pragma warning restore CS0162 // Unreachable code detected
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Creatures.LoadAsset<GameObject>("FleshBlobLeaderPrefab"));
        obj.SetActive(false);
