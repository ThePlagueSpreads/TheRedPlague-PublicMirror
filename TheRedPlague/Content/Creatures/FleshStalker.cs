...
public class FleshStalker : CreatureAsset
{
    ...
    {
        var template = new CreatureTemplate(() => AssetBundles.Creatures.LoadAsset<GameObject>("MutantStalker_Prefab"),
    ...
    {
        MaterialUtils.ApplySNShaders(prefab, 6, 1.5f, 1,
            new ColorMultiplierModifier(1.5f),
            new FresnelModifier(0.05f));
    }
}