...
using TheRedPlague.Content.Environment.Blood;
using UnityEngine;
...
public static class GrabberPrefab
{
    ...
    {
        var grabberObj = Object.Instantiate(AssetBundles.Creatures.LoadAsset<GameObject>("GrabberPrefab"));
        ...
        var bloodSplashPrefab = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("GrabberBloodSplash"), grabberObj.transform);
        ...
        grabberObj.AddComponent<ConstructionObstacle>();
        grabberObj.AddComponent<VFXSurface>().surfaceType = VFXSurfaceTypes.organic;
