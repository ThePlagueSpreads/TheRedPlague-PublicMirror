...
public class ChaosLeviathanPrefab : CreatureAsset
{
    ...
    {
        var template = new CreatureTemplate(() => AssetBundles.Creatures.LoadAsset<GameObject>("ChaosLeviathanPrefab"),
            BehaviourType.Leviathan, EcoTargetType.Leviathan, 66666666)
        {
            ...
            BehaviourLODData = new BehaviourLODData(10000, 20000, 30000),
