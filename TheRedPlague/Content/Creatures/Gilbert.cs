...
public class Gilbert : CreatureAsset
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Gilbert")
        .WithIcon(AssetBundles.Creatures.LoadAsset<Sprite>("GilbertIcon"))
    ...
    {
        var template = new CreatureTemplate(() => AssetBundles.Creatures.LoadAsset<GameObject>("Gilbert.prefab"),
