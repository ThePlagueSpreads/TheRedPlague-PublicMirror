...
public class SuckerController : CreatureAsset
{
    ...
    {
        prefabInfo.WithIcon(AssetBundles.Core.LoadAsset<Sprite>("SuckerItemIcon"));
    }

    protected override CreatureTemplate CreateTemplate()
    {
        var template = new CreatureTemplate(() => AssetBundles.Core.LoadAsset<GameObject>("SuckerController"),
            BehaviourType.MediumFish, EcoTargetType.MediumFish, 100f)
        {
            ...
            CanBeInfected = false,
            PickupableFishData = new PickupableFishData(TechType.Hoverfish,
                "SuckerV2", "SuckerV2_VIEWMODEL"),
            BioReactorCharge = 267,
            EdibleData = new EdibleData(2, 1, true)
        };
        return template;
    }
    ...
    protected override void PostRegister()
    {
        ...
        var cookedSprite = AssetBundles.Core.LoadAsset<Sprite>("CookedSuckerIcon");
        CookedCreatureHandler.RegisterAllCreatureFood(this, null, null, cookedSprite,
            null, null, cookedSprite,
            new EdibleData(11, 3, true),
            new VFXFabricatingData("CookedModel/CraftModel", -0.2f, 0.2f, new Vector3(0, 0.16f, 0), 15, new Vector3(-90, 0, 0)));
        
        PDAHandler.AddCustomScannerEntry(PrefabInfo.TechType, 2, false, "Sucker");
    }
}