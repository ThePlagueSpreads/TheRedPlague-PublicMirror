...
public class DomeDeconstructionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (goalManager.IsGoalComplete(Act1Story.DronesReadyForDomeConstruction.key))
        {
            return;
        }
    ...
    {
        _progressBarObject = Instantiate(AssetBundles.Core.LoadAsset<GameObject>("TadpoleProgressBar"));
