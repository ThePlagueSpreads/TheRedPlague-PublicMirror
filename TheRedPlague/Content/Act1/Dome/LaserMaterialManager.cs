...
public class LaserMaterialManager : MonoBehaviour, IStoryGoalListener
{
    ...
    private void Start()
    {
        ...
        if (!StoryGoalManager.main.IsGoalComplete(Act1Story.DomeConstructionFinishedEvent.key))
        {
    ...
    {
        if (string.Equals(key, Act1Story.DomeConstructionFinishedEvent.key, StringComparison.OrdinalIgnoreCase))
        {
