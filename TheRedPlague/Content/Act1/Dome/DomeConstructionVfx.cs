...
public class DomeConstructionVfx : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (goalManager && goalManager.IsGoalComplete(Act1Story.DomeConstructionEvent.key))
        {
            yield break;
        }
    ...
    {
        Act1Story.PrepareForDomeConstruction.Trigger();
        yield return new WaitForSeconds(5);
        Act1Story.DomeConstructionEvent.Trigger();
    ...
    {
        var drone = Instantiate(AssetBundles.Core.LoadAsset<GameObject>("TadpolePrefab"));
