...
namespace TheRedPlague.Content.TitleScreen;
...
public static class TrpTitleScreen
{
    ...
    private static GameObject SpawnMainMenuButtons()
    {
        ...
        rectTransform.anchorMin = new Vector2(0.92f, 0.07f);
        rectTransform.anchorMax = new Vector2(0.92f, 0.07f);
        rectTransform.offsetMax = new Vector2(0, 20);
        ...
        // ADD BUTTONS
        SpawnButton("RedPlagueDiscordText", rectTransform, () => OpenURL("https://discord.gg/SCJBD2yvxG"));
        ...
        textTransform.localPosition = new Vector3(0, 145);
