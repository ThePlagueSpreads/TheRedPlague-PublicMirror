...
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("FleshPlant3").WithFolderPath(TrpPrefabFolders.Environment.Flesh);
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("FleshPlant3"));
        obj.SetActive(false);
