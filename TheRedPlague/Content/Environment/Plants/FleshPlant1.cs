...
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("FleshPlant1").WithFolderPath(TrpPrefabFolders.Environment.Flesh);
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("FleshPlant1"));
        obj.SetActive(false);
