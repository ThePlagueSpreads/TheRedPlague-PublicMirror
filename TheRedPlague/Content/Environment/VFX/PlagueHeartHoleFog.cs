...
namespace TheRedPlague.Content.Environment.VFX;

[PrefabClass]
public static class PlagueHeartHoleFog
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PlagueHeartHoleFog")
        .WithFolderPath(TrpPrefabFolders.Vfx);
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PlagueHeartCaveFog"));
        obj.SetActive(false);
