...
public class FleshBlockPrefab
{
    ...
    private void Register()
    {
        ...
        prefab.SetGameObject(new CloneTemplate(Info, _cloneClassId)
        {
            ModifyPrefab = obj =>
            {
                ...
                meshCollider.sharedMesh = AssetBundles.Core.LoadAsset<GameObject>("FleshBlockCollision")
    ...
    private class TextureSet
    {
        ...
        public void LoadTextures()
        {
            var textures = new[]
            {
                AssetBundles.Common.LoadAsset<Texture2D>("FB_" + Name + "Diffuse"),
                AssetBundles.Common.LoadAsset<Texture2D>("FB_" + Name + "Normal"),
                AssetBundles.Common.LoadAsset<Texture2D>("FB_" + Name + "SIG"),
            };
