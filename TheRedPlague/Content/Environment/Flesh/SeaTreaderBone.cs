...
public class SeaTreaderBone
{
    ...
    {
        var prefab = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>(_modelName));
        prefab.SetActive(false);
        foreach (var renderer in prefab.GetComponentsInChildren<Renderer>(true))
        {
            renderer.material = AssetBundles.Core.LoadAsset<Material>("SeaTreaderSkeleton");
