...
public static class BoneArmor
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PlagueArmor")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("BoneArmorIcon"))
    ...
    private static void Register()
    {
        ...
        prefab.SetRecipe(new RecipeData(new Ingredient(ConsciousNeuralMatter.Info.TechType, 1),
                new Ingredient(WarperHeart.Info.TechType, 1),
                new Ingredient(AmalgamatedBone.Info.TechType, 6),
        ...
        new DataboxPrefab("BoneArmorDatabox", Info.TechType).Register();
    }
    ...
    public static void RegisterLateStoryData()
    {
        KnownTechHandler.SetAnalysisTechEntry(new KnownTech.AnalysisTech
        {
            ...
            storyGoals = new List<StoryGoal> { Act2Story.UnlockPlagueArmorGoal },
            unlockPopup = AssetBundles.Core.LoadAsset<Sprite>("BoneArmorPopup"),
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("BoneArmor_Prefab"));
        obj.SetActive(false);
