...
namespace TheRedPlague.Content.Equipment.InfectionSampler;

[PrefabClass]
public static class InfectionSamplerTool
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("InfectionSampler")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("TransfuserIcon"));
    ...
    public static void RegisterLateStoryData()
    {
        KnownTechHandler.SetAnalysisTechEntry(new KnownTech.AnalysisTech
        {
            ...
            storyGoals = new List<StoryGoal> { Act1Story.UnlockTransfuserEvent},
            unlockPopup = AssetBundles.Core.LoadAsset<Sprite>("TransfuserPopup"),
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("Transfuser_Prefab"));
        obj.SetActive(false);
