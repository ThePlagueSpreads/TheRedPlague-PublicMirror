...
using TheRedPlague.Content.Equipment.AirStrikeDevice;
using UnityEngine;

namespace TheRedPlague.Content.Equipment.AlterraBomb;
...
public static class AlterraBomb
{
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("ExplosiveCratePrefab"));
        obj.SetActive(false);
