...
namespace TheRedPlague.Content.Equipment.AirStrikeDevice;

[PrefabClass]
public static class AirStrikeDevice
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("AirStrikeDevice", false)
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("AirStrikeDeviceIcon"));
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("AirStrikeDevicePrefab"));
        obj.SetActive(false);
