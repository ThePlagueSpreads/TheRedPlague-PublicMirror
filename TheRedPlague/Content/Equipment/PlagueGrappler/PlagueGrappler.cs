...
namespace TheRedPlague.Content.Equipment.PlagueGrappler;

[PrefabClass]
public static class PlagueGrappler
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PlagueGrappler")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("PlagueGrapplerIcon"));
    ...
    private static void Register()
    {
        ...
        new DataboxPrefab("PlagueGrapplerDatabox", Info.TechType).Register();
    }
    ...
    public static void RegisterLateStoryData()
    {
        KnownTechHandler.SetAnalysisTechEntry(new KnownTech.AnalysisTech
        {
            ...
            storyGoals = new List<StoryGoal> { Act2Story.UnlockPlagueGrapplerGoal},
            unlockPopup = AssetBundles.Core.LoadAsset<Sprite>("PlagueGrapplerPopup"),
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PlagueGrappler"));
        obj.SetActive(false);
