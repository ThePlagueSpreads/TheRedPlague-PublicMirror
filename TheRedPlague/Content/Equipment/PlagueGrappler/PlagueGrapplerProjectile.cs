...
public class PlagueGrapplerProjectile : MonoBehaviour
{
    ...
    {
        var accel = Player.main.gameObject.AddComponent<AcceleratePlayer>();
    ...
    public void SpawnDestroyVfx()
    {
        ...
        var vfx = Instantiate(AssetBundles.Core.LoadAsset<GameObject>("DrifterCannonProjectileShatterPrefab"),
