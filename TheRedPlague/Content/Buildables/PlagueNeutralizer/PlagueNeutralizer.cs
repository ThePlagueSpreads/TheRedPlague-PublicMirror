...
public static class PlagueNeutralizer
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PlagueNeutralizer")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("PlagueNeutralizerIcon"));
    ...
    private static void Register()
    {
        ...
        KnownTechHandler.SetAnalysisTechEntry(Info.TechType, System.Array.Empty<TechType>(),
            ...
            AssetBundles.Core.LoadAsset<Sprite>("PlagueNeutralizerPopup"));
    }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        liquidObj.AddComponent<MeshFilter>().mesh = AssetBundles.Core.LoadAsset<Mesh>("PlagueNeutralizerLiquid");
    ...
    private static Material CreateLiquidMaterial()
    {
        ...
        liquidMaterial.mainTexture = AssetBundles.Core.LoadAsset<Texture2D>("NeutralizerLiquidDiffuse");
        ...
        liquidMaterial.SetTexture("_AnimMask", AssetBundles.Core.LoadAsset<Texture2D>("AnalyzerLiquidAnimMask"));
