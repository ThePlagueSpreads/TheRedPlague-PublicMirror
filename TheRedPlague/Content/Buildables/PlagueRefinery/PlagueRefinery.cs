...
namespace TheRedPlague.Content.Buildables.PlagueRefinery;
...
public static class PlagueRefinery
{
    ...
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PlagueRefinery")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("PlagueRefineryIcon"));
    ...
    private static void Register()
    {
        ...
        KnownTechHandler.SetAnalysisTechEntry(Info.TechType, System.Array.Empty<TechType>(),
            ...
            AssetBundles.Core.LoadAsset<Sprite>("PlagueRefineryPopup"));
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PlagueRefineryPrefab"));
        obj.SetActive(false);
        ...
        behavior.grinderBloodDiffuse = AssetBundles.Core.LoadAsset<Texture2D>("GrinderBloodyDiffuse");
        behavior.grinderBloodSpecular = AssetBundles.Core.LoadAsset<Texture2D>("GrinderBloodySpec");
