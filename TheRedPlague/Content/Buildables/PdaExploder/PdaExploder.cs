...
public static class PdaExploder
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("PdaExploder")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("PdaExploderIcon"));
    ...
    private static void Register()
    {
        ...
        KnownTechHandler.SetAnalysisTechEntry(new KnownTech.AnalysisTech
        {
            ...
            unlockPopup = AssetBundles.Core.LoadAsset<Sprite>("PdaExploderPopup"),
    ...
    {
        var prefab = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PdaExploderPrefab"));
