...
namespace TheRedPlague.Content.Buildables.SatelliteCommunicator;
...
public static class SatelliteCommunicationDevice
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("SatelliteCommunicationDevice")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("SatelliteCommunicatorIcon"));
    ...
    private static void Register()
    {
        ...
        prefab.SetRecipe(new RecipeData(new Ingredient(TechType.TitaniumIngot, 1),
            ...
            new Ingredient(PrecursorTabletRegistration.GoldTabletInfo.TechType, 1)));
        ...
        KnownTechHandler.SetAnalysisTechEntry(new KnownTech.AnalysisTech
        {
            ...
            unlockPopup = AssetBundles.Core.LoadAsset<Sprite>("SatelliteCommunicatorPopup"),
    ...
    {
        var prefab = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("SatelliteCommunicatorPrefab"));
