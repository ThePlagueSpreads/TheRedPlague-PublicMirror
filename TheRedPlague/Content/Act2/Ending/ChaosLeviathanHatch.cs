...
using TheRedPlague.Framework.CreatureBehaviours.Actions;
...
public class ChaosLeviathanHatch : MonoBehaviour
{
    ...
    public static IEnumerator PlaySequence(Transform plagueHeartTransform, GameObject chaosPrefab)
    {
        ...
        lod.veryCloseThreshold = 10000;
        lod.closeThreshold = 20000;
        lod.farThreshold = 30000;
        ...
        trailManagerManager.dataAsset = AssetBundles.Creatures.LoadAsset<TextAsset>("ChaosTrailManagers");
        ...
        var ring = Instantiate(AssetBundles.Creatures.LoadAsset<GameObject>("ChaosLeviathanRingPrefab"),
            chaos.transform);
