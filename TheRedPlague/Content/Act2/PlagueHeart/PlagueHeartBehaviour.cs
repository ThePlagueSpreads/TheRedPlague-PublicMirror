...
public class PlagueHeartBehaviour : MonoBehaviour, IScheduledUpdateBehaviour
{
    ...
    private void Start()
    {
        ...
        if (StoryGoalManager.main.IsGoalComplete(Act2Story.MeteorExplodeGoal.key))
        {
            DisableMeteorAfterReload();
        }

        var forcefieldDisabled = StoryGoalManager.main.IsGoalComplete(Act2Story.PlagueHeartForceFieldDisableGoal.key);
        ...
        if (StoryGoalManager.main.IsGoalComplete(Act2Story.OpenPlagueHeartHatchGoal.key))
        {
            OpenHatchAfterReload();
        }
        
        if (StoryGoalManager.main.IsGoalComplete(Act2Story.MeteorEggHatchGoal.key))
        {
            HatchEggAfterReload();
        }
    ...
    public void ExplodeMeteor()
    {
        ...
        Act2Story.MeteorExplodeGoal.Trigger();
    ...
    public void DisableForceField()
    {
        ...
        Act2Story.PlagueHeartForceFieldDisableGoal.Trigger();
    ...
    public void OpenHatch()
    {
        ...
        Act2Story.OpenPlagueHeartHatchGoal.Trigger();
    ...
    public void HatchEgg()
    {
        ...
        eggAnimator.SetBool(AnimParamOpen, true);
        Act2Story.MeteorEggHatchGoal.Trigger();
    }
