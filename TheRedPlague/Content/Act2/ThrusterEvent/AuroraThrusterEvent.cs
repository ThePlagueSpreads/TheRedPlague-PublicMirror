...
public class AuroraThrusterEvent : MonoBehaviour
{
    ...
    private static readonly FMODAsset Music = AudioUtils.GetFmodAsset("NotOurShipAnymore");
    ...
    {
        Act2Story.AuroraThrusterEvent.Trigger();
        // TrpEventMusicPlayer.PlayMusic(Music, 35, false);
        
        _startTime = Time.time;
        var firePrefab = AssetBundles.Core.LoadAsset<GameObject>("AuroraEngineParticle");
        ...
        auroraAnimator.runtimeAnimatorController = AssetBundles.Core.LoadAsset<RuntimeAnimatorController>("Aurora-MainPrefab");
