...
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("CyclopsTentacle").WithFolderPath(TrpPrefabFolders.Environment.Flesh);
    ...
    {
        var obj = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("CyclopsTentaclePrefab"));
        obj.SetActive(false);
