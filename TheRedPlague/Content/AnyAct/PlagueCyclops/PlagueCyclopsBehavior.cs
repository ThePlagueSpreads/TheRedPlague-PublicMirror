...
namespace TheRedPlague.Content.AnyAct.PlagueCyclops;
...
public class PlagueCyclopsBehavior : MonoBehaviour
{
    ...
    {
        var tentacles = Instantiate(AssetBundles.Core.LoadAsset<GameObject>("CyclopsInfestationSequencePrefab"), transform);
    ...
    {
        var exteriorModel = Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PlagueCyclopsAttachments"), transform);
