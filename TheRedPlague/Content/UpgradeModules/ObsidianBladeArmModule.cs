...
public static class ObsidianBladeArmModule
{
    public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("ObsidianBladeArmModule")
        .WithIcon(AssetBundles.Core.LoadAsset<Sprite>("PrawnBladeIcon"));
    ...
    private static void Register()
    {
        ...
        prefab.SetUnlock(Info.TechType)
            .WithAnalysisTech(AssetBundles.Core.LoadAsset<Sprite>("PrawnBladePopup"),
        ...
        new DataboxPrefab("ObsidianArmDatabox", Info.TechType).Register();
    }

    private static IEnumerator GetPrefab(IOut<GameObject> result)
    {
        var prefab = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PrawnBladeItemPrefab"));
    ...
    private static IEnumerator GetPrawnSuitArmPrefab(IOut<GameObject> result)
    {
        ...
        // Spawn blade model
        var bladeModel = Object.Instantiate(AssetBundles.Core.LoadAsset<GameObject>("PrawnBladeArmPrefab"),
