...
namespace TheRedPlague.Registration.Audio;

public static class ModAudio
{
    private static AssetBundle Bundle => AssetBundles.Audio;
    ...
    public const int HallucinationSoundCount = 7;
    ...
    private static IEnumerator RegisterAudioAsyncInternal(WaitScreenHandler.WaitScreenTask task)
    {
        ...
        var builder = new FModSoundBuilder(new AssetBundleSoundSource(Bundle));

        builder.CreateNewEvent("IslandElevatorActivation", SfxBus)
            .SetSound("IslandElevatorActivation")
            .SetMode3D(10, 200)
            .Register();
        ...
        RegisterSoundWithVariants("InfectedWarperIdle",
            new[]
                { "WarperSound1", "WarperSound2", "WarperSound3", "WarperSound4", "WarperSound5" },
            SfxBus, 5f, 30f);
        RegisterSoundWithVariants("CloseJumpScare",
            // yep, I skip #4 and #5
            new[] { "CloseScare1", "CloseScare2", "CloseScare3", "CloseScare6" },
        ...
        RegisterSoundWithVariants("SmallZombieBite",
            ...
            SfxCreatures, 2f, 6f);
        Register2DSound("DomeBaseZap", "DomeBaseZap", SfxBus);
        ...
        */
        ...
        RegisterSoundWithVariants("MrTeethScream", new[]
            {
                "MrTeethScream1", "MrTeethScream2", "MrTeethScream3", "MrTeethScream4",
                "MrTeethScream5", "MrTeethScream6", "MrTeethScream7"
            },
            ReverbSendBus, 2f, 120f);
        ...
        RegisterSoundWithVariants("DrifterVocalizeClose",
            ["drifter_roar_1", "drifter_roar_2", "drifter_roar_3", "drifter_roar_4", "drifter_roar_5"],
            ReverbSendBus, 5f, 170);
        RegisterSoundWithVariants("DrifterVocalizeFar",
            ["drifter_far_1", "drifter_far_2", "drifter_far_3", "drifter_far_4", "drifter_far_5"],
            ReverbSendBus, 5f, 170);
        ...
        RegisterSoundWithVariants("PustuleExplosion", new[] { "PustuleExplosion1", "PustuleExplosion2", "PustuleExplosion3" },
            ReverbSendBus, 4f, 25f);
        ...
        RegisterSound("InsectoidWalk", "InsectoidWalkLoop", SfxBus, 1f, 6f, 0, true);
        ...
        RegisterSound("PlagueAltarCorpseCreation", "PlagueAltarCorpseCreation", IndoorBus, 5f, 50f);
        ...
        RegisterMusic("InTheVeins", "in the veins", 0.5f);
        ...
        Register2DSound("BiochemicalSuitRechargeRequired", "BiochemicalSuitRechargeRequired", AudioUtils.BusPaths.VoiceOvers);
        ...
        for (int i = 1; i <= HallucinationSoundCount; i++)
        {
            var hallucinationSoundName = "SoundHallucination" + i;
            var sound = AudioUtils.CreateSound(Bundle.LoadAsset<AudioClip>(hallucinationSoundName), AudioUtils.StandardSoundModes_3D);
            sound.set3DMinMaxDistance(1, 100f);

            CustomSoundHandler.RegisterCustomSound(hallucinationSoundName, sound, SfxBus);
        }
        ...
        RegisterSoundWithVariants("Crungus",
            new[] { "Crungus-01", "Crungus-02", "Crungus-03", "Crungus-04", "Crungus-05" },
            SfxBus, 5f, 350f);
        ...
        RegisterAmbience("DomeBaseAmbience", "domebaseambience1", 2f, AudioUtils.BusPaths.SFX);

        // Scares
        var whispersOfTheDeadAClipNames = new string[10];
        for (int i = 1; i <= whispersOfTheDeadAClipNames.Length; i++)
        {
            whispersOfTheDeadAClipNames[i - 1] = "WhispersOfTheDeadA-" + i;
        }
        RegisterSoundWithVariants("WhispersOfTheDeadA", whispersOfTheDeadAClipNames, SfxBus, 10f, 40f);
    ...
    [System.Obsolete("This method is too slow. Do not use.")]
