...
namespace TheRedPlague.Framework.Behaviour.Precursor;
...
public abstract class GenericPrecursorReceptacle : HandTarget, IHandTarget
{
    ...
    public void OnHandClick(GUIHand hand)
    {
        ...
        var removedItem = global::Inventory.main.container.RemoveItem(techType);

        if (removedItem == null) return;

        _restoreQuickSlot = global::Inventory.main.quickSlots.activeSlot;
        global::Inventory.main.ReturnHeld(true);
        _insertedItem = removedItem.gameObject;
        _insertedItem.transform.SetParent(global::Inventory.main.toolSocket);
    ...
    public void OnPlayerCinematicModeEnd(PlayerCinematicController controller)
    {
        ...
        {
            global::Inventory.main.quickSlots.Select(_restoreQuickSlot);
        }
    }
